...
namespace praxicloud.core.metrics.consoleprovider
{
    ...
    /// </summary>
    public sealed class ConsoleMetricsProvider : SimpleMetricsProvider
    {
        #region Variables
        /// <summary>
        ...
        public ConsoleMetricsProvider(long reportingInterval, bool includeLabels) : base(reportingInterval, null)
        {
